...
export default function TermsAndConditions() {
  ...
  return (
    <div className="terms-and-conditions legal">
      <PageHelmet title="JacobHewitson.com - Terms and Conditions" />
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to JacobHewitson.com.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <strong>Material</strong> refers to content published on this website
        ...
        <li>
          <p>
            <strong>Website</strong> refers to JacobHewitson.com, accessible
            from{" "}
            <a
              href="http://jacobhewitson.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://jacobhewitson.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://jacobhewitson.com/#/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://jacobhewitson.com/#/contact
          </a>
        </li>
        <li>
          By emailing us:{" "}
          <a
            href="mailto:jacob.a.hewitson@gmail.com"
            rel="external nofollow noopener"
            target="_blank"
          >
            jacob.a.hewitson@gmail.com
          </a>
        </li>
      </ul>
      <p>
      ...
      <ul>
        <li>
          Logo and any other Material found in the project entry image for
          LeapsAndBoundsPreK.com found at{" "}
          <a
            href="https://jacobhewitson.com/#/projects"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://jacobhewitson.com/#/projects
          </a>{" "}
          (Permission was given to include a screenshot of the site built for
          the client by the Company to be hosted on the Service. Ownership of
          the Logo and other copyrighted Material in this image belongs to Leaps
          and Bounds Preschool in Colorado Springs, CO).
        </li>
        <li>
          Logo and any other Material found in the project entry image for
          MineGrinder.com found at{" "}
          <a
            href="https://jacobhewitson.com/#/projects"
            rel="external nofollow noopener"
            target="_blank"
          ...
          (Permission was given to include a screenshot of the site built for
          the client by the Company to be hosted on the Service. Ownership of
          the Logo and other copyrighted Material in this image belong to Dave
          Hewitson).
        </li>
      </ul>
      <p>
      ...
      <ul>
        <li>
          The Default Image for project entries found at{" "}
          <a
            href="https://jacobhewitson.com/#/projects"
            rel="external nofollow noopener"
            target="_blank"
        ...
        <li>
          The sub-header of the Other Services page found at{" "}
          <a
            href="https://jacobhewitson.com/#/other-services"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://jacobhewitson.com/#/other-services
          </a>
        </li>
        <li>
          The Notary Public description of the Other Services page found at{" "}
          <a
            href="https://jacobhewitson.com/#/other-services"
            rel="external nofollow noopener"
            target="_blank"
